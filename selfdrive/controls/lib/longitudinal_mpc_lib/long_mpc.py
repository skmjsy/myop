...
A_EGO_COST = 0.
J_EGO_COST = 5.0
A_CHANGE_COST = .12  #Comma default = .5, Neokii = .125  기본 0.5인데 낮을 수록 선행차에 민감하게 반응합니다.
...
MIN_ACCEL = -3.5
T_FOLLOW = 1.45 #기본 1.45초인데 속도가 곱해지고 6미터가 더해져 유지거리가 됩니다. 이 값을 줄이면 유지거리를 줄이는 효과는 있으나 브레이크가 아닌 회생제동으로는 갑작스런 변화에 대응하지 못할 수도 있습니다.
COMFORT_BRAKE = 2.5
STOP_DISTANCE = 6.0
