...
A_CRUISE_MAX_VALS = [1.6, 1.17, 1.02, 0.87, 0.72, 0.6]
...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    accel_limits_turns[0] = min(accel_limits_turns[0], self.a_desired + 0.05, a_min_sol) #dp
    ...
    #dp
    self.mpc.update(sm['carState'], sm['radarState'], sm['modelV2'], sm['controlsState'], v_cruise_sol, x, v, a, j, y, prev_accel_constraint, lightSensor)
