...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent) {
  ...
  //opkr
  QObject::connect(uiState(), &UIState::offroadTransition, homeWindow, &HomeWindow::offroadTransition);
  QObject::connect(uiState(), &UIState::offroadTransition, homeWindow, &HomeWindow::offroadTransitionSignal);

  settingsWindow = new SettingsWindow(this);
  main_layout->addWidget(settingsWindow);
  QObject::connect(settingsWindow, &SettingsWindow::closeSettings, this, &MainWindow::closeSettings);
  QObject::connect(uiState(), &UIState::offroadTransition, settingsWindow, &SettingsWindow::offroadTransition);
