...
QT_MOC_LITERAL(1, 22, 14), // "left_blindspot"
QT_MOC_LITERAL(2, 37, 15) // "right_blindspot"

    },
    "AnnotatedCameraWidget\0left_blindspot\0"
    "right_blindspot"
};
#undef QT_MOC_LITERAL
...
void AnnotatedCameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->left_blindspot; break;
        case 1: *reinterpret_cast< bool*>(_v) = _t->right_blindspot; break;
        default: break;
        }
        ...
        switch (_id) {
        case 0:
            if (_t->left_blindspot != *reinterpret_cast< bool*>(_v)) {
                _t->left_blindspot = *reinterpret_cast< bool*>(_v);
            }
            break;
        case 1:
            if (_t->right_blindspot != *reinterpret_cast< bool*>(_v)) {
                _t->right_blindspot = *reinterpret_cast< bool*>(_v);
            }
            break;
        default: break;
        }
