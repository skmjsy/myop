...
QT_MOC_LITERAL(6, 83, 10), // "VisionBuf*"
QT_MOC_LITERAL(7, 94, 13), // "vipcConnected"
QT_MOC_LITERAL(8, 108, 11) // "vipc_client"
...
void CameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraWidget::*)(VisionBuf * );
...
// SIGNAL 2
void CameraWidget::vipcThreadFrameReceived(VisionBuf * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
