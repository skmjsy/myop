...
QUERY_RADIUS = 1000 #3000  # mts. Radius to use on OSM data queries.
MIN_DISTANCE_FOR_NEW_QUERY = 200 #1000  # mts. Minimum distance to query area edge before issuing a new query.
